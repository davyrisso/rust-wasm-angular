...
export const PrimitiveType = Object.freeze({
    Cube: 0, "0": "Cube",
    Tetrahedron: 1, "1": "Tetrahedron",
    Octahedron: 2, "2": "Octahedron",
});
...
export class Mesh {
    ...
    /**
     * @param {PrimitiveType} primitive_type
     * @returns {Mesh}
     */
    static from_primitive(primitive_type) {
        const ret = wasm.mesh_from_primitive(primitive_type);
     ...
     */
    get_vertices() {
        const ret = wasm.mesh_get_vertices(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {Uint16Array}
     */
    get_indices() {
        const ret = wasm.mesh_get_indices(this.__wbg_ptr);
        var v1 = getArrayU16FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 2, 2);
        return v1;
    }
    subdivide() {
        wasm.mesh_subdivide(this.__wbg_ptr);
    }
}
